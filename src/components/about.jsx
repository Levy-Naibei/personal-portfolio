        ...
        <div className="colorlib-narrow-content">
            ...
            <div className="col-md-4 text-center animate-box">
                ...
                <div className="desc">
                    ...
                    <p>I have experience building web applications using ReactJS, HTML, CSS, SCSS</p>
                </div>
                </div>
            </div>
            <div className="col-md-4 text-center animate-box">
            ...
            <div className="col-md-4 text-center animate-box">
                ...
                <div className="desc">
                    <h3>CI/CD</h3>
                    <p>I have great understanding of Continous Deployment Continous Integration</p>
                </div>
                </div>
            </div>
            {/*
